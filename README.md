...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/scine-readuct-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/scine-readuct-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add scine-readuct scine-readuct-python
# for installing globally
pixi global install scine-readuct scine-readuct-python
```
...
It is possible to list all of the versions of `scine-readuct` available on your platform:
...
```
pixi search scine-readuct --channel conda-forge
```
